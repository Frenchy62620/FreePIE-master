...
namespace FreePIE.Core.Plugins
{
    ...
    public class Device : IDisposable
    {
        ...
        public int[] Capabilities => new int[]{joystick.Capabilities.AxeCount, joystick.Capabilities.ButtonCount, joystick.Capabilities.PovCount};
        ...
        public int HeldDown(int button, int nbvalue, int lapse) => getPressedStrategy.HeldDown(button, IsDown(button), nbvalue, lapse);
    ...
    public class JoystickGlobal
    {
        ...
        public bool getPressedBip(int button, int frequency, int duration = 300) => getPressed(button).Beep(frequency, duration);

        // ****************** button getReleased ************************************
        public bool getReleased(int button) => device.IsReleased(button);
        public bool getReleasedBip(int button, int frequency, int duration = 300) => getReleased(button).Beep(frequency, duration);
        ...
        public bool getClickedBip(int button, bool dblclick = false, int frequency = 300, int duration = 300) => getClicked(button, dblclick).Beep(frequency, duration);
        ...
        public void setRange(int minvalue, int maxvalue, int idAxis = -1) => device.SetRange(minvalue, maxvalue, idAxis);
        ...
        public int[] Capabilities => device.Capabilities;
        public string Name => device.getNameOfJoy(); 
