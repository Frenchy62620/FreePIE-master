...
namespace FreePIE.GUI.Views.Main.Menu
{
    public class MainMenuViewModel : PropertyChangedBase,
        ...
        Core.Common.Events.IHandle<ExitingEvent>, Core.Common.Events.IHandle<ExitEvent>,
        ...
        Core.Common.Events.IHandle<RunEvent>
    {
        ...
        public void Handle(ExitEvent message)
        {
            ...
            {
                eventAggregator.Publish(new ScriptDocumentAddedEvent((ScriptEditorViewModel)activeDocument, true));
                CreateScriptViewModel(message.Script);
                RunScript();
            }
        }
