...
using FreePIE.Plugin_Yei3Space.Globals;
using FreePIE.Plugin_Yei3Space.SensorFusion;
using FreePIE.Plugin_Yei3Space.Yei3Space;

namespace FreePIE.Plugin_Yei3Space
{
